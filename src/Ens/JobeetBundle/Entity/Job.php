...
class Job {
    ...
    /**
     * Retourne le nom de l'entreprise formaté pour ajouter les paramètres dans l'URL
     * @return String
     */
    ...
    /**
     * Retourne le poste recherché formaté
     * @return String
     */
    ...
    public function extend(){
        ...
        $this->expires_at=new \DateTime(date('Y-m-d H:i:s'), time()+(30*86400));
        return true;
    }
